                  ...
                  <div class="row">
                    <div class="col-md-4 col-sm-6">
                      <center><img src="{{ asset('img/patient-icon.png') }}" class="img-profile rounded-circle img-fluid"></center>
                       <h4 class="text-center"><b>{{ $patient->name }}</b> <label class="badge badge-primary-soft"> <a href="{{ url('patient/edit/'.$patient->id) }}" ><i class="fa fa-pen"></i></a></label></h4>
                            ...
                            <p><b>{{ __('sentence.Age') }} :</b> {{ $patient->Patient->birthday }} ({{ \Carbon\Carbon::parse($patient->Patient->birthday)->age }} Años)</p>
                            @endisset
                            ...
                            <p><b>{{ __('sentence.Email') }} :</b> {{ $patient->Patient->patient_id }}</p>
                            
                            
                            <p><b>ARS :</b> {{ $patient->Patient->ars }}</p>
                            
                            
                            <p><b>Afiliado :</b> {{ $patient->Patient->afiliado }}</p>
                            
                            @isset($patient->Patient->adress)
                            <p><b>{{ __('sentence.Address') }} :</b> {{ $patient->Patient->adress }}</p>
                            @endisset
                            @isset($patient->Patient->weight)
                            <p><b>{{ __('sentence.Weight') }} :</b> {{ $patient->Patient->weight }} Lb.</p>
                            @endisset

                            @isset($patient->Patient->height)
                            <p><b>{{ __('sentence.Height') }} :</b> {{ $patient->Patient->height }} Ft.</p>
                            @endisset
                    ...
                    <div class="col-md-8 col-sm-6">
                      <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                          <a class="nav-link" id="documents-tab" data-toggle="tab" href="#documents" role="tab" aria-controls="documents" aria-selected="false">Archivos Médicos</a>
                        </li>
                        <li class="nav-item" role="presentation">
                        ...
                        {{-- <li class="nav-item" role="presentation">
                          <a class="nav-link" id="dentist-tab" data-toggle="tab" href="#Dentist" role="tab" aria-controls="Dentist" aria-selected="false">{{ __('sentence.Dentist') }}</a>
                        </li> --}}
                      </ul>
                        ...
                        <div class="tab-pane fade" id="Dentist" role="tabpanel" aria-labelledby="dentist-tab">
                          <table class="table">
                            <tbody>
                              ...
                              <tr>
                                <td>Dentist Degree:</td>
                                <td>{{$doctor->degree1??''}} , {{$doctor->degree2}}</td>
                              </tr>
                              <tr>

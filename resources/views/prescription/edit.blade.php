                  ...
                  <div class="repeatable">
                      @foreach($prescription_certificate as $item)
                            <div class="field-group row">
                             ...
                             <div class="col-md-4">
                                 <div class="form-group-custom">
                                     <textarea id="strength" name="p_description[]"  class="form-control" placeholder="{{ __('sentence.Description') }}"></textarea>
                                    <input type="hidden" name="prescription_certificate_id[]" value="{{ $item->id }}">

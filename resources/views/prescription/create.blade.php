...
<form method="post" action="{{ route('prescription.store') }}">
   ...
   <div class="row justify-content-center">
      <div class="col-md-4">
         <div class="card shadow mb-4">
            ...
            <div class="card-body">
               ...
               <div class="form-group">
                  <input type="submit" value="{{ __('sentence.Save') }}" class="btn btn-warning btn-block" align="center">
               </div>
            </div>
         </div>
      </div>
      <div class="col-md-8">
         ...
         <div class="card shadow mb-4">
            <div class="card-header py-3">
               <h6 class="m-0 font-weight-bold text-primary">{{ __('sentence.Certificate') }}</h6>
            </div>
            <div class="card-body">
               <fieldset class="certificate_labels">
                  <div class="repeatable"></div>
                  <div class="form-group">
                     <a type="button" class="btn btn-sm btn-primary add text-white" align="center"><i class='fa fa-plus'></i> {{ __('sentence.Add Certificate') }}</a>
                  </div>
               </fieldset>
            </div>
         </div>
...
<script type="text/template" id="certificate_labels">
   <div class="field-group row">
       <div class="col-md-8">
           <div class="form-group-custom">
               <textarea name="p_description[]"  class="form-control" placeholder="{{ __('sentence.Description') }}" tabindex="-1" aria-hidden="true" required></textarea>
           </div>
       </div>
       <div class="col-md-3">
           <a type="button" class="btn btn-danger delete text-white btn-sm" align="center"><i class='fa fa-plus'></i> {{ __('sentence.Remove') }}</a>

...
<html lang="en">
   <head>
      ...
      <title>LifeCare - @yield('title') </title>
      ...
      <div id="app">
         ...
         <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
               ...
               {{-- <li class="nav-item">
                  <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePermission" aria-expanded="true" aria-controls="collapseTwo">
               ...
               @endif
               {{-- <li class="nav-item">
                  <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseDentist" aria-expanded="true" aria-controls="collapseTwo">
                  <i class="fas fa-fw fa-users"></i>
                  <span>Dentists</span>
                  </a>
                  <div id="collapseDentist" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                     <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ route('dentist.create') }}">Create Dentist</a>
                        <a class="collapse-item" href="{{ route('dentist.index') }}">All Dentists</a>
                     </div>
                  </div>
               </li> --}}
               <!-- Divider -->
               ...
               <li class="nav-item">
                  ...
                  <i class="fas fa-fw fa-users"></i>
                  <span>{{ __('sentence.Sectaries') }}</span>
                  </a>
                  <div id="collapseSectary" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                     <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ route('sectary.create') }}">{{ __('sentence.New Sectary') }}</a>
                        <a class="collapse-item" href="{{ route('sectary.index') }}">{{ __('sentence.All Sectaries') }}</a>
                     </div>
                  </div>
               </li>
               @endif
               ...
               <li class="nav-item">
                  ...
                  <i class="fas fa-fw fa-users"></i>
                  <span>{{ __('sentence.Clinics') }}</span>
                  </a>
                  <div id="collapseClinic" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                     <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ route('clinic.create') }}">{{ __('sentence.New Clinic') }}</a>
                        <a class="collapse-item" href="{{ route('clinic.index') }}">{{ __('sentence.All Clinics') }}</a>
                     </div>
                  </div>
               </li>
               @endif
               ...
               <hr class="sidebar-divider">
               {{-- @endif --}}
               @if(Auth()->user()->role !='sectary' || Auth()->user()->role=='admin')
               <li class="nav-item">
                  <a class="nav-link" href="#" data-toggle="collapse" data-target="#collapsePages" aria-expanded="true" aria-controls="collapsePages">
                  <i class="fas fa-fw fa-pills"></i>
                  <span>{{ __('sentence.Drugs list') }}</span>
                  </a>
               ...
               <li class="nav-item">
                  ...
                  <div id="collapseSettings" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                     <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ route('doctorino_settings.edit') }}">LifeCare Settings</a>
                        @if(Auth()->user()->role!='admin')
                  ...
                  <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                     ...
                     <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                           ...
                           <img class="img-profile rounded-circle" src="{{ asset('img/logo.png') }}" style="background:#004bad;">
                           </a>
               ...
               <footer class="sticky-footer bg-white">
                  <div class="container my-auto">
                     <div class="copyright my-auto">
                        <span>Copyright &copy; Created by <a href="https://publi-soft.com/">LifeCare</a> {{ date('Y') }}</span>

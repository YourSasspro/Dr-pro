    ...
    <div class="card-body">
        <form method="POST" action="{{ route("users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="degree1" id="degree1" value="{{ old('degree1', $user->degree1) }}">
                <span class="help-block"></span>
            </div>
            {{-- <div class="form-group">
                <label class="required" for="degree2">Doctor Specialty</label>
                <input class="form-control" type="text" name="degree2" id="degree2" value="{{ old('degree2', $user->degree2) }}">
                <span class="help-block"></span>
            </div> --}}
            <div class="form-group">

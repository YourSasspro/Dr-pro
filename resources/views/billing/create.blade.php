            ...
            <div class="card-body">
               ...
               <div class="form-group">
                  ...
                  <select class="form-control" name="payment_mode" id="PaymentMode">
                     ...
                     <option value="Cheque">Deposito</option>
                  </select>
               </div>

               <div class="form-group">
                  <label for="DepositedAmount">Monto Recibido</label>
                  <input class="form-control" type="number" name="deposited_amount" id="DepositedAmount">
               </div>

               <div class="form-group">
                  <label for="DueAmount">Devuelta o Restante</label>
      ...
      <div class="col-md-8">
         <div class="card shadow mb-4">
            ...
            <div class="card-body">
               ...
               <span class="float-right">ltebis :  {{ App\Setting::get_option('vat') }} %</span><br>

      ...
      <div class="card shadow mb-4">
         <div class="card-body">
           ...
           <hr style="border-top: 2px solid #2450d3; margin-top: 2px;">
            ...
            <div class="row">
               <div class="col">
                  <p class="font-size-12">{!! $setting->footer_left??$billing->perception->footer_left??'' !!}</p>
               </div>
               <div class="col">
                  <p class="float-right font-size-12">{!! $setting->footer_right??$billing->perception->footer_right??'' !!}</p>
               </div>
            </div>

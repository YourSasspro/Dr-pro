                        ...
                        <div class="col-lg-6">
                           <div class="p-5">
                              <div class="text-center">
                                 <h1 class="h4 text-gray-900 mb-4"><?php echo e(__('sentence.Welcome')); ?> LifeCare</h1>
                              </div>
...
unset($__errorArgs, $__bag); ?>" name="email" value="<?php echo e(old('email')); ?>" required autocomplete="email" autofocus  aria-describedby="emailHelp" placeholder="Email">
...
</html><?php /**PATH D:\projects\doctor-management\resources\views/auth/login.blade.php ENDPATH**/ ?>
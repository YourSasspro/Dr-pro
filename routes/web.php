...
// Dentist
Route::delete('dentist/destroy', 'DentistController@massDestroy')->name('dentist.massDestroy');
Route::resource('dentist', 'DentistController');

//sectary
Route::resource('sectary','SectaryController');
Route::post('deleteSectary', 'SectaryController@destroy')->name('deleteSectary');
//clinic
Route::resource('clinic','ClinicController');
Route::post('deleteClinic', 'ClinicController@destroy')->name('deleteClinic');
...
Route::get('/patient/view/{id}', 'PatientController@view');
...
Route::get('/prescription/pdf/{id}','PrescriptionController@pdf_generate')->where('id', '[0-9]+');
...
Route::get('/billing/filter', 'BillingController@filter')->name('billing.filter');
...
Route::get('/settings/prescription_settings', 'PreceiptionSettingController@index')->name('prescription_settings.edit');
Route::post('/settings/prescription_settings', 'PreceiptionSettingController@store')->name('prescription_settings.store');
